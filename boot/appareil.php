                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterappareil.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM appareil");
if(mysqli_num_rows($req) == 0){
    echo "il n'y a pas encore d'appareil ajouter !";

}else {
    while($row=mysqli_fetch_assoc($req)){
        ?>
        <tr>
            <td><?=$row['type_dappareil']?></td>
            <td><?=$row['adresse']?></td>
            <td><?=$row['mot_de_pass']?></td>
            <td><?=$row['ip']?></td>
            <td><a href="modifierappareil.php?id_appareil=<?=$row['id_appareil']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerappareil.php?id_appareil=<?=$row['id_appareil']?>"> <img src="images/effacer.png"></a></td>
