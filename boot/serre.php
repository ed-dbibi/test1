        ...
        <div class="row">
            <div class="col-md-12 head">
                ...
                <div class="float-right">
                    ...
                    <form action="importer/imserre.php" method="POST" enctype="multipart/form-data" class="d-inline1">
                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterserre.php" method="post" class="d-inline">
                                ...
                                <a href="exporter/exserre.php" class="btn btn-success1"><i class="dwn"></i> Export</a>
                    <form action="pdf/gserre.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM serre");
if(mysqli_num_rows($req) == 0){
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            ...
            <td><?=$row['rendement']?></td>
            <td><?=$row['id_bloc']?></td>
            <td><a href="modifierserre.php?id_serre=<?=$row['id_serre']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerserre.php?id_serre=<?=$row['id_serre']?>"> <img src="images/effacer.png"></a></td>
