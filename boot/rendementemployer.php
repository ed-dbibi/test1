        ...
        <div class="row">
            <div class="col-md-12 head">
                ...
                <div class="float-right">
                    ...
                    <form action="import.php" method="POST" enctype="multipart/form-data" class="d-inline1">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Rendement d'employer</h1>
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterRE.php" method="post" class="d-inline">
                                ...
                                <a href="export.php" class="btn btn-success1"><i class="dwn"></i> Export</a>
                    <form action="genererpdf.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM rendement_demployer");
if(mysqli_num_rows($req) == 0){
    echo "il n'y a pas encore des serre ajouter !";
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            ...
            <td><?=$row['date']?></td>
            <td><?=$row['quantite']?></td>
            <td><?=$row['typedelaquantite']?></td>
            
            <td><a href="modifierRE.php?id_rd=<?=$row['id_rd']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerRE.php?id_rd=<?=$row['id_rd']?>"> <img src="images/effacer.png"></a></td>
