            ...
            <div class="col-md-12 head">
                ...
                <div class="float-right">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Condition climatique</h1>
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterCC.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM condition_climatique");
if(mysqli_num_rows($req) == 0){
    echo "il n'y a pas encore des  ajoute!";
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            <td><?=$row['EC']?></td>
            <td><?=$row['PH']?></td>
            <td><?=$row['temperature_max']?></td>
            <td><?=$row['temperature_min']?></td>
            <td><?=$row['date']?></td>
            <td><?=$row['id_serre']?></td>
            <td><a href="modifierCC.php?id_cc=<?=$row['id_cc']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerCC.php?id_cc=<?=$row['id_cc']?>"> <img src="images/effacer.png"></a></td>
