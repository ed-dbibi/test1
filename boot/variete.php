                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajoutervariete.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM variete");
if(mysqli_num_rows($req) == 0){
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            ...
            <td><?=$row['id_culture']?></td>
            <td><a href="modifiervariete.php?id_variete=<?=$row['id_variete']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimervariete.php?id_variete=<?=$row['id_variete']?>"> <img src="images/effacer.png"></a></td>
