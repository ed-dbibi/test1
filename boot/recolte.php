        ...
        <div class="row">
            <div class="col-md-12 head">
                ...
                <div class="float-right">
                    ...
                    <form action="importer/imrecolte.php" method="POST" enctype="multipart/form-data" class="d-inline1">
                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterrecolte.php" method="post" class="d-inline">
                                ...
                                <a href="exporter/exrecolte.php" class="btn btn-success1"><i class="dwn"></i> Export</a>
                    <form action="pdf/grecolte.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM récolte");
if(mysqli_num_rows($req) == 0){
    echo "il n'y a pas encore des récolte ajouter !";
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            <td><?=$row['quantite']?></td>
            <td><?=$row['type_de_recolte']?></td>
            <td><?=$row['date']?></td>
            <td><?=$row['id_serre']?></td>
            <td><?=$row['id']?></td>
            <td><a href="modifierrecolte.php?id_recolte=<?=$row['id_recolte']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerrecolte.php?id_recolte=<?=$row['id_recolte']?>"> <img src="images/effacer.png"></a></td>
