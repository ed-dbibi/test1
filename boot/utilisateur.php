                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterutilisateur.php" method="post" class="d-inline">
...
if(mysqli_num_rows($req) == 0){
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            ...
            <td><?=$row['username']?></td>
            <td><?=$row['password']?></td>
            <td><?=$row['id_appareil']?></td>
            <td><?=$row['droit_dacces']?></td>
            
            <td><a href="modifierutilisateur.php?id_utilisateur=<?=$row['id_utilisateur']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerutilisateur.php?id_utilisateur=<?=$row['id_utilisateur']?>"> <img src="images/effacer.png"></a></td>
