                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterferme.php" method="post" class="d-inline">
                                ...
                                <a href="exporter/exferme.php" class="btn btn-success1"><i class="dwn"></i> Export</a>
                                    ...
                                    <tbody>
                                        ...
                                        if(mysqli_num_rows($req) == 0){
                                            ...
                                            while($row = mysqli_fetch_assoc($req)){
                                                ...
                                                echo "<td><a href='modifierferme.php?id=" . $row['id'] . "'> <img src='images/bouton-modifier.png'></a></td>";
                                                echo "<td><a href='supprimerferme.php?id=" . $row['id'] . "'> <img src='images/effacer.png'></a></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
