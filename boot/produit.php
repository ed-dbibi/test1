                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterproduit.php" method="post" class="d-inline">
...
if(mysqli_num_rows($req) == 0){
    echo "il n'y a pas encore des ferme ajouter !";

}else {
    while($row=mysqli_fetch_assoc($req)){
        ?>
        <tr>
            <td><?=$row['nom_commercial']?></td>
            <td><?=$row['prix']?></td>
            <td><?=$row['unite']?></td>
            <td><?=$row['doses']?></td>
            <td><a href="modifierproduit.php?id_produit=<?=$row['id_produit']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerproduit.php?id_produit=<?=$row['id_produit']?>"> <img src="images/effacer.png"></a></td>
