    ...
    <body class="sb-nav-fixed">
        ...
        <div class="row">
            <div class="col-md-12 head">
                ...
                <div class="float-right">
                    ...
                    <form action="importer/imferme.php" method="POST" enctype="multipart/form-data" class="d-inline1">
                        <input type="file" name="import_file">
                        <button type="submit" name="save_excel_data" class="btn btn-primary4">Importe</button>
                    </form>
                </div>
            </div>
        </div>
        <style>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Traitement chimique</h1>
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajoutertt.php" method="post" class="d-inline">
                                ...
                                <a href="exporter/extraitementchimique.php" class="btn btn-success1"><i class="dwn"></i> Export</a>
                    <form action="pdf/gferme.php" method="post" class="d-inline">
                    ...
                    <th>quantite_eau</th>
                    <th>bouillie</th>
                    <th>unite_bouillie</th>
                    <th>heure de la debut</th>
...
$req = mysqli_query($conn , " SELECT * FROM traitement_chimique");
if(mysqli_num_rows($req) == 0){
    echo "il n'y a pas encore des traitement chimique  ajouter !";
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            <td><?=$row['type']?></td>
            <td><?=$row['date']?></td>
            <td><?=$row['quantite_eau']?></td>
            <td><?=$row['bouillie']?></td>
            <td><?=$row['unite_bouillie']?></td>
            <td><?=$row['heuredebut']?></td>
            <td><?=$row['heurefin']?></td>
            <td><a href="modifiertt.php?id_tc=<?=$row['id_tc']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimertt.php?id_tc=<?=$row['id_tc']?>"> <img src="images/effacer.png"></a></td>
