...
if (mysqli_num_rows($result) > 0) {
    ...
    $pdf->Cell(40, 10, 'superficie', 1);
    $pdf->Cell(40, 10, 'rendement', 1);
    $pdf->Cell(40, 10, 'bloc', 1);
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $pdf->Cell(35, 10, $row['numero'], 1);
        $pdf->Cell(40, 10, $row['superficie'], 1);
        
        $pdf->Cell(40, 10, $row['rendement'], 1);
        $pdf->Cell(40, 10, $row['id_bloc'], 1);
