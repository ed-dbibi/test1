        ...
        <div class="row">
            <div class="col-md-12 head">
                ...
                <div class="float-right">
                    ...
                    <form action="importer/imemployer.php" method="POST" enctype="multipart/form-data" class="d-inline1">
                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouteremployer.php" method="post" class="d-inline">
                                ...
                                <a href="exporter/exemployer.php" class="btn btn-success1"><i class="dwn"></i> Export</a>
                    <form action="pdf/gemployer.php" method="post" class="d-inline">
                        ...
                        if(mysqli_num_rows($req) == 0){
                            echo "<tr><td colspan='12'>Aucun employé ajouté !</td></tr>";
                        } else {
                            while($row = mysqli_fetch_assoc($req)){
                                ...
                                echo "<td>" . $row['role'] . "</td>";
                                echo "<td>" . $row['rendement'] . "</td>";
                                echo "<td>" . $row['id_serre'] . "</td>";
                                echo "<td><a href='modifieremployer.php?idemp=" . $row['idemp'] . "'> <img src='images/bouton-modifier.png'></a></td>";
                                echo "<td><a href='supprimeremployer.php?idemp=" . $row['idemp'] . "'> <img src='images/effacer.png'></a></td>";
                                echo "</tr>";
                            }
                        }
                    ?>
