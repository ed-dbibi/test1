            ...
            <div class="col-md-12 head">
                ...
                <div class="float-right">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Rendement des serre</h1>
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterRS.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM rendement_desserre");
if(mysqli_num_rows($req) == 0){
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            ...
            <td><a href="modifierRS.php?id_rs=<?=$row['id_rs']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerRS.php?id_rs<?=$row['id_rs']?>"> <img src="images/effacer.png"></a></td>
