    ...
    <body class="sb-nav-fixed">
        ...
        <div class="row">
            ...
            <div class="float-right">
                    ...
                    <form action="importer/imbloc.php" method="POST" enctype="multipart/form-data" class="d-inline1">
                       ...
                       <!-- <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <form action="ajouterbloc.php" method="post" class="d-inline">
                                ...
                                <a href="exporter/exbloc.php" class="btn btn-success1"><i class="dwn"></i> Export</a>
                    <form action="pdf/gbloc.php" method="post" class="d-inline">
...
$req = mysqli_query($conn , " SELECT * FROM bloc");
if(mysqli_num_rows($req) == 0){
    echo "il n'y a pas encore bloc ajouter !";
    ...
    while($row=mysqli_fetch_assoc($req)){
        ...
        <tr>
            ...
            <td><?=$row['rendement']?></td>
            <td><?=$row['id']?></td>
            <td><a href="modifierbloc.php?id_bloc=<?=$row['id_bloc']?>"> <img src="images/bouton-modifier.png"></a></td>
            <td><a href="supprimerbloc.php?id_bloc=<?=$row['id_bloc']?>"> <img src="images/effacer.png"></a></td>
